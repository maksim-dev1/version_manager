  ...
  _i3.Future<List<_i6.AppVersion>> getVersionsByFilters(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'version',
            method: 'getVersionsByFilters',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'version',
          methodName: 'getVersionsByFilters',
          parameters: _i1.testObjectToJson({
            'applicationId': applicationId,
            'platform': platform,
          }),
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          ...
          parameters: _i1.testObjectToJson({'appVersion': appVersion}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
  ...
  _i3.Future<List<_i6.AppVersion>> blockUnblockVersion(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'version',
            method: 'blockUnblockVersion',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'version',
          methodName: 'blockUnblockVersion',
          parameters: _i1.testObjectToJson({
            'id': id,
            'isBlocked': isBlocked,
            'reason': reason,
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          ...
          parameters: _i1.testObjectToJson({'version': version}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
